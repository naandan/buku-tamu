...
!(function (t, e) {
  ...
  function Ze(t, e = "x") {
    ...
    !(function (t, e, i) {
      ...
      for (let c = 0; c < s - 1; ++c)
        (l = h),
          (h = qe(t, c + 1)),
          l && h && (N(e[c], 0, Xe) ? (i[c] = i[c + 1] = 0) : ((n = i[c] / e[c]), (o = i[c + 1] / e[c]), (r = Math.pow(n, 2) + Math.pow(o, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[c] = n * a * e[c]), (i[c + 1] = o * a * e[c]))));
    })(t, n, o),
      (function (t, e, i = "x") {
        const s = Ke(i),
          n = t.length;
  ...
  class Go extends Es {
    ...
    drawBody(t, e, i) {
      ...
      let b, x, _, y, v, w, M;
      for (
        e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = Xo(this, m, i), e.fillStyle = i.bodyColor, d(this.beforeBody, p), f = a && "right" !== m ? ("center" === o ? l / 2 + h : l + 2 + h) : 0, y = 0, w = s.length;
        y < w;
        ++y
      ) {
