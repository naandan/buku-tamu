    ...
    function (e, t, r) {
      ...
      var n = function e(t, r) {
        ...
        o = function () {
          ...
          return (
            (r = r.substring(r.lastIndexOf("{") + 1, r.lastIndexOf("}"))).split(";").forEach(function (t) {
              if (t) {
                var r = t.split(": ")[0],
                  n = t.split(": ")[1];
        ...
        u = function (e) {
          ...
          return (
            7 === e.length
              ...
              : ((t = parseInt(e.slice(1, 2), 16)), (r = parseInt(e.slice(2, 3), 16)), (n = parseInt(e.slice(3, 5), 16))),
        ...
        l = function (e) {
          ...
          return (
            7 === e.length
              ? ((r = parseInt(e.slice(1, 3), 16)), (n = parseInt(e.slice(3, 5), 16)), (o = parseInt(e.slice(5, 7), 16)))
              : ((r = parseInt(e.slice(1, 2), 16)), (n = parseInt(e.slice(2, 3), 16)), (o = parseInt(e.slice(3, 5), 16))),
            "rgba("
              .concat(r, ", ")
              .concat(n, ", ")
              .concat(o, ", ")
      ...
      t.default = { deepObjectsMerge: n, getColor: s, getStyle: a, hexToRgb: u, hexToRgba: l, makeUid: f, pickByKeys: d, rgbToHex: p };
    },
  ]).default;
});
